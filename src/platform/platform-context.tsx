...
export function PlatformProvider({ service, children }: { readonly service: PlatformService; readonly children: ReactNode }) {
	return <PlatformContext value={service}>{children}</PlatformContext>;
}
